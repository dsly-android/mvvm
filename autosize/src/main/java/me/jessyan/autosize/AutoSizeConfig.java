...
public final class AutoSizeConfig {
     ...
     * 设置字体放大倍数
     */
    public AutoSizeConfig setFontMagnification(float multiple) {
        SPUtils.getInstance().put("font_magnification", multiple);
        return this;
    }
    ...
    public float getFontMagnification() {
        return SPUtils.getInstance().getFloat("font_magnification", 1);
    }
