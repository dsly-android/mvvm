package com.android.dsly.zxing.widget;
...
public final class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        //初始化自定义属性信息
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.zxing_ViewfinderView);
        maskColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_maskColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_mask));
        frameColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_frameColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_frame));
        cornerColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_cornerColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_corner));
        laserColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_laserColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_laser));
        resultPointColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_resultPointColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_result_point_color));

        labelText = array.getString(R.styleable.zxing_ViewfinderView_zxing_labelText);
        labelTextColor = array.getColor(R.styleable.zxing_ViewfinderView_zxing_labelTextColor, ContextCompat.getColor(context,R.color.zxing_viewfinder_text_color));
        labelTextSize = array.getDimension(R.styleable.zxing_ViewfinderView_zxing_labelTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,14f,getResources().getDisplayMetrics()));
        labelTextPadding = array.getDimension(R.styleable.zxing_ViewfinderView_zxing_labelTextPadding,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,24,getResources().getDisplayMetrics()));
        labelTextLocation = TextLocation.getFromInt(array.getInt(R.styleable.zxing_ViewfinderView_zxing_labelTextLocation,0));

        isShowResultPoint = array.getBoolean(R.styleable.zxing_ViewfinderView_zxing_showResultPoint,false);

        frameWidth = array.getDimensionPixelSize(R.styleable.zxing_ViewfinderView_zxing_frameWidth,0);
        frameHeight = array.getDimensionPixelSize(R.styleable.zxing_ViewfinderView_zxing_frameHeight,0);

        laserStyle = LaserStyle.getFromInt(array.getInt(R.styleable.zxing_ViewfinderView_zxing_laserStyle, LaserStyle.LINE.mValue));
        gridColumn = array.getInt(R.styleable.zxing_ViewfinderView_zxing_gridColumn,20);
        gridHeight = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_gridHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,40,getResources().getDisplayMetrics()));

        cornerRectWidth = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_cornerRectWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,4,getResources().getDisplayMetrics()));
        cornerRectHeight = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_cornerRectHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,16,getResources().getDisplayMetrics()));
        scannerLineMoveDistance = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_scannerLineMoveDistance,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,2,getResources().getDisplayMetrics()));
        scannerLineHeight = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_scannerLineHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,5,getResources().getDisplayMetrics()));
        frameLineWidth = (int)array.getDimension(R.styleable.zxing_ViewfinderView_zxing_frameLineWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,1,getResources().getDisplayMetrics()));
        scannerAnimationDelay = array.getInteger(R.styleable.zxing_ViewfinderView_zxing_scannerAnimationDelay,15);
        frameRatio = array.getFloat(R.styleable.zxing_ViewfinderView_zxing_frameRatio,0.625f);
        array.recycle();
