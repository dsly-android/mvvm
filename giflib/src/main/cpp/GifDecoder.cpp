...
static JNINativeMethod gGifDecoderMethods[] = {
        // create method.
        {"nativeDecodeFile",       "(Ljava/lang/String;)Lcom/android/dsly/giflib/GifDecoder;",      (void *) gifdecoder::nativeDecodeFile},
        {"nativeDecodeStream",     "(Ljava/io/InputStream;[B)Lcom/android/dsly/giflib/GifDecoder;", (void *) gifdecoder::nativeDecodeStream},
        {"nativeDecodeByteArray",  "([BII)Lcom/android/dsly/giflib/GifDecoder;",                    (void *) gifdecoder::nativeDecodeByteArray},
        {"nativeDecodeByteBuffer", "(Ljava/nio/ByteBuffer;II)Lcom/android/dsly/giflib/GifDecoder;", (void *) gifdecoder::nativeDecodeByteBuffer},
        // other method.
...
jint GifDecoder_OnLoad(JNIEnv *env) {
    jclass jclsGifDecoder = env->FindClass("com/android/dsly/giflib/GifDecoder");
