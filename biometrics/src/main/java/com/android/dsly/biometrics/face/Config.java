...
public class Config {
    ...
    public static String apiKey = "OYznwPv4KPYWp7BjNorQP8e2";
    public static String secretKey = "ArlEGnjqV6Th9rORFP2E2XS8r6kxgdD6";
    public static String licenseID = "biometrics-face-android";
    ...
    public static String groupID = "face1";
