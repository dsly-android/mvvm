...
import com.android.dsly.biometrics.face.APIService;
import com.android.dsly.biometrics.face.exception.FaceError;
import com.android.dsly.biometrics.face.model.AccessToken;
import com.android.dsly.biometrics.face.model.RequestParams;
import com.android.dsly.biometrics.face.parser.AccessTokenParser;
import com.android.dsly.biometrics.face.parser.Parser;
...
public class HttpUtil {
    ...
    public <T> void post(String path, String key, RequestParams params,
        ...
        try {
            Log.i("wtf", "body size->" + body.contentLength());
        } catch (IOException e) {
            e.printStackTrace();
        }
        body.setKey(key);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("wtf", "onResponse json->" + responseString);
                final T result;
                try {
